...
const products = [
  { productName: "Cutlet", imagePath: "/img/cutlet.webp", viewCount: 20 },
  { productName: "Kebab", imagePath: "/img/kebab-fresh.webp", viewCount: 20 },
  { productName: "Kebab", imagePath: "/img/kebab.webp", viewCount: 20 },
  { productName: "Lavash", imagePath: "/img/lavash.webp", viewCount: 20 },
  { productName: "Lavash", imagePath: "/img/lavash.webp", viewCount: 20 },
  { productName: "Cutlet", imagePath: "/img/cutlet.webp", viewCount: 20 },
  { productName: "Kebab", imagePath: "/img/kebab.webp", viewCount: 20 },
  { productName: "Kebab", imagePath: "/img/kebab-fresh.webp", viewCount: 20 },
                        ...
                        <div className="view-wrapper">
                          ...
                          <Button className={"view-btn"} sx={{ right: "36px" }}>
                            <Badge badgeContent={20} color="secondary">
                              <RemoveRedEyeIcon
                                sx={{ color: product.viewCount ===20 ? "gray" : "white" }}
                              />
                            </Badge>
                          </Button>
                        </div>
